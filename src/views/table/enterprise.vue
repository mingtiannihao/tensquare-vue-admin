...
<el-input v-model="searchMap.name" placeholder="企业名称"></el-input></el-form-item>
  ...
  <el-table
    ...
    style="width: 100%">
          ...
          <el-table-column prop="ishot" label="是否热门" width="80">
        <template scope="scope">
            <span v-if="scope.row.ishot==1" style="color:red;">热门</span>
            <span v-if="scope.row.ishot==0" style="color:green;">冷门</span>
        </template>
          </el-table-column>
  ...
  <el-dialog title="编辑" :visible.sync="dialogFormVisible">
    <el-form label-width="80px">
        <el-form-item label="企业名称"><el-input v-model="pojo.name" placeholder="企业名称"></el-input></el-form-item>
