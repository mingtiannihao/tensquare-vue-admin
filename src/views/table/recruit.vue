...
<el-input v-model="searchMap.education" placeholder="学历要求"></el-input></el-form-item>
  ...
  <el-table
    ...
    style="width: 100%">
        ...
        <template scope="scope">
            <span v-if="scope.row.state==1" style="color:red;">热门</span>
            <span v-if="scope.row.state==0" style="color:green;">冷门</span>
        </template>
          </el-table-column>
  ...
  <el-dialog title="编辑" :visible.sync="dialogFormVisible">
    <el-form label-width="80px">
        ...
        <el-form-item label="薪资范围"><el-input v-model="pojo.salary" placeholder="例如： 5000-8000"></el-input></el-form-item>
        <el-form-item label="经验要求"><el-input v-model="pojo.condition"></el-input></el-form-item>
        <el-form-item label="学历要求"><el-input v-model="pojo.education"  placeholder="例如： 本科"></el-input></el-form-item>
