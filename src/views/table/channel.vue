...
<el-input v-model="searchMap.state" placeholder="状态"></el-input></el-form-item>
  ...
  <el-table
    ...
    style="width: 100%">
      ...
      <template slot-scope="scope">
        <el-button @click="handleEdit(scope.row.id)" type="text" size="small">频道管理</el-button>        
      </template>
    </el-table-column>
  </el-table>
      <el-pagination
 ...
 <el-dialog title="编辑" :visible.sync="dialogFormVisible">
     <el-form label-width="80px">
        ...
        <el-form-item label="状态"><el-switch v-model="pojo.state" active-value="1" inactive-value="0"></el-switch></el-input></el-form-item>
  ...
  methods: {
    ...
    handleSave() {
      if (this.id !== '') {
        ...
        channelApi.save(this.pojo).then(response => {
          this.$message({
            message: response.message,
            type: (response.flag ? 'success' : 'error')
          })
